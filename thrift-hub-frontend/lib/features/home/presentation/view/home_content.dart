    ...
    return ListView(
      ...
      children: [
        ...
        const Row(
          ...
          children: [
            Text("Premium Vape Products", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => TripDetailPage(trip: {
                          ...
                          'price': '\$${package['price']?.toString() ?? '0'} ',
                          'rating': '4.5',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                  Text('\$${package['price']?.toString() ?? '0'} ', style: const TextStyle(color: Colors.redAccent)),
